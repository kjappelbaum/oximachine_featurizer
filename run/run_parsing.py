...
@click.command('indir', default='/mnt/lsmo_databases/mof_subset_csdmay2019')
@click.command('outname', default=None)
def main(indir, output_name):
    """
    CLI function
    """
    names_cleaned = prepare_list(indir)
    run_parsing(names_cleaned, output_name)
