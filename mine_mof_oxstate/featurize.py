...
FEATURE_LABELS_ALL = [
    'wt CN_1', 'sgl_bd CN_1', 'wt CN_2', 'L-shaped CN_2', 'water-like CN_2', 'bent 120 degrees CN_2',
    'bent 150 degrees CN_2', 'linear CN_2', 'wt CN_3', 'trigonal planar CN_3', 'trigonal non-coplanar CN_3',
    'T-shaped CN_3', 'wt CN_4', 'square co-planar CN_4', 'tetrahedral CN_4', 'rectangular see-saw-like CN_4',
    'see-saw-like CN_4', 'trigonal pyramidal CN_4', 'wt CN_5', 'pentagonal planar CN_5', 'square pyramidal CN_5',
    'trigonal bipyramidal CN_5', 'wt CN_6', 'hexagonal planar CN_6', 'octahedral CN_6', 'pentagonal pyramidal CN_6',
    'wt CN_7', 'hexagonal pyramidal CN_7', 'pentagonal bipyramidal CN_7', 'wt CN_8', 'body-centered cubic CN_8',
    'hexagonal bipyramidal CN_8', 'wt CN_9', 'q2 CN_9', 'q4 CN_9', 'q6 CN_9', 'wt CN_10', 'q2 CN_10', 'q4 CN_10',
    'q6 CN_10', 'wt CN_11', 'q2 CN_11', 'q4 CN_11', 'q6 CN_11', 'wt CN_12', 'cuboctahedral CN_12', 'q2 CN_12',
    'q4 CN_12', 'q6 CN_12', 'wt CN_13', 'wt CN_14', 'wt CN_15', 'wt CN_16', 'wt CN_17', 'wt CN_18', 'wt CN_19',
    'wt CN_20', 'wt CN_21', 'wt CN_22', 'wt CN_23', 'wt CN_24', 'CN_VoronoiNN', 'local difference in Number',
    'local difference in MendeleevNumber', 'local difference in AtomicWeight', 'local difference in MeltingT',
    'local difference in Column', 'local difference in Row', 'local difference in CovalentRadius',
    'local difference in Electronegativity', 'local difference in NsValence', 'local difference in NpValence',
    'local difference in NdValence', 'local difference in NfValence', 'local difference in NValence',
    'local difference in NsUnfilled', 'local difference in NpUnfilled', 'local difference in NdUnfilled',
    'local difference in NfUnfilled', 'local difference in NUnfilled', 'local difference in GSvolume_pa',
    'local difference in GSbandgap', 'local difference in GSmagmom', 'local difference in SpaceGroupNumber',
    'BOOP Q l=1', 'BOOP Q l=2', 'BOOP Q l=3', 'BOOP Q l=4', 'BOOP Q l=5', 'BOOP Q l=6', 'BOOP Q l=7', 'BOOP Q l=8',
    'BOOP Q l=9', 'BOOP Q l=10', 'G2_0.05', 'G2_4.0', 'G2_20.0', 'G2_80.0', 'G4_0.005_1.0_1.0', 'G4_0.005_1.0_-1.0',
    'G4_0.005_4.0_1.0', 'G4_0.005_4.0_-1.0', 'number', 'row', 'column', 'random_column'
]
...
class FeatureCollector:  # pylint:disable=too-many-instance-attributes
    ...
    def create_clean_dataframe(feature_list: list, label_list: list) -> pd.DataFrame:
        ...
        df_cleaned['random_column'] = np.random.randint(0, 18, len(df_cleaned))
        return df_cleaned
